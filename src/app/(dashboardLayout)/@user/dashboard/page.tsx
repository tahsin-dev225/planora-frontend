 ...
 * Displays personal metrics for the logged-in user
 */
const UserDashboardPage = () => {
        ...
        return (
            <div className="flex h-[450px] items-center justify-center rounded-xl border border-dashed border-red-200 bg-red-50/50 p-8 text-center">
                <div className="space-y-3">
                    ...
                    <h3 className="text-lg font-semibold text-red-900">Failed to load your stats</h3>
                    <p className="text-sm text-red-600/80">We couldn't retrieve your dashboard data right now.</p>
                </div>
            </div>
        );
    }

    // Adjusted configuration for User metrics
    const cards = [
        {
            title: "Total Events",
            value: stats?.totalEvents || 0,
            description: "Available Platform Events",
            icon: CalendarFold,
            color: "text-blue-600",
            bg: "bg-blue-50",
            trend: "Live"
        },
        {
            ...
            description: "Events Joined by You",
            icon: Trophy,
    ...
    return (
        <div className="space-y-10 p-0 md:p-2 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <Card key={i} className="group relative overflow-hidden border-muted/60 transition-all hover:border-primary/20 hover:shadow-lg hover:shadow-primary/5">
                        ...
                        <CardContent>
                            <div className="flex items-baseline justify-between">
                                ...
                                <div className="flex items-center gap-0.5 text-[10px] font-medium text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded-full border border-blue-100">
            ...
            {/* Charts Section - Using User Participation Data */}
            <div className="grid gap-6 grid-cols-1 mb-8">
                <EventsBarChart data={stats?.myParticipatedPerMonth || []} title="Monthly Participation" description="Events Joined by You" />
            </div>
        </div>
    );
};
