          ...
          <div className="space-y-12 block">
            ...
            <div className="space-y-6">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                Transforming Your Ideas into <span className="text-teal-500 italic font-serif">Memorable Events</span>
              </h1>
              ...
              <Link
                href="/events"
                className="inline-block bg-[#1f1f1f] border border-gray-700 hover:border-teal-500 text-white font-medium px-8 py-3 transition-colors duration-300 relative group overflow-hidden"
              >
                <span className="relative z-10">View All Events</span>
                <div className="absolute inset-0 bg-teal-600 translate-y-full group-hover:translate-y-0 transition-transform duration-300 z-0"></div>
              </Link>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start relative">
          ...
          <div className="col-span-1 lg:col-span-5 space-y-12">
            <div className="space-y-6">
              ...
              {/* Features List */}
              <div className="grid grid-cols-2 gap-y-4 gap-x-6 text-gray-400 text-sm md:text-base">
                {[
          ...
          <div className="col-span-1 lg:col-span-7 relative flex justify-end mt-12 lg:mt-0">
            ...
            <div className="absolute bottom-10 left-0 md:-left-12 bg-[#1a1a1a] border border-gray-800 p-8 shadow-2xl max-w-[320px] md:max-w-sm z-10 before:absolute before:inset-0 before:border-l-4 before:border-teal-500 before:pointer-events-none">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-4">
                We are passionate creators dedicated to making your event seamless, breathtaking, and thoroughly unforgettable. With a decade of expertise, our team leaves nothing to chance.
              </p>
              <Image
